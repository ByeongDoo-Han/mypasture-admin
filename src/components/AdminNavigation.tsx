...
import { BarChart3, BellRing, BookOpenText, BrainCircuit, CalendarCheck, ListChecks, TicketPercent } from 'lucide-react';
...
const items = [
  ...
  { href: '/coupons', label: '체험 쿠폰', icon: TicketPercent },
];
